...
Unified Java backend standards and reusable skill for module-first architecture, strict naming conventions, third-party integration boundaries, Redis-based concurrency control, and full module API regression.
